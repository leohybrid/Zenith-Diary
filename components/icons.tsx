...
// Using a simple utility for icons. In a real project, use a library like lucide-react.
const createIcon = (path: React.ReactNode) => (props: SVGProps<SVGSVGElement>) => (
  <svg
...
export const CalendarDays = createIcon(<><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></>);
...
export const BookHeart = createIcon(<><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /><path d="M16 12a4 4 0 1 0-8 0 4 4 0 0 0 8 0Z" /></>);
...
export const Sparkles = createIcon(<><path d="m12 3-1.9 3.8-3.8 1.9 3.8 1.9L12 14.4l1.9-3.8 3.8-1.9-3.8-1.9z" /><path d="M22 12a10 10 0 1 1-10-10" /><path d="M3 12a9 9 0 0 1 9-9" /></>);
